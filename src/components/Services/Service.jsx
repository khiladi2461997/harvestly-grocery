...
const Service = () => {
  ...
  return (
    <div className="flex flex-col items-center ">
      <div  className="block max-w-lg p-6 rounded-lg  hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
      {servicesData.map((service, index) => (
        <div
          className="grid gap-4 items-center justify-between"
          key={index}
          onMouseEnter={() => setHoveredIndex(index)}
          onMouseLeave={() => setHoveredIndex(null)}
        >
          <div
            className={`${service.class} rounded-full ${
